 ...
 * Use the {@link MaintenanceMaintainerFragment#newInstance} factory method to
...
public class MaintenanceMaintainerFragment extends Fragment {
    ...
    public static MaintenanceMaintainerFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_maintenance_maintainer, container, false);
        context = getActivity();
        progressBar = view.findViewById(R.id.progressBar);
        ListView listView = view.findViewById(R.id.maintenance_list);
        reusableAdapter = new ReusableAdapter<Maintenance>(maintenanceList, R.layout.item_maintenance_maintainer) {
            @Override
                                ...
                                new Thread() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            ...
                                            if (conn != null) {
                                                ps = conn.prepareStatement("UPDATE maintenance SET maintenance_status = ?, maintenance_maintainer = ? WHERE maintenance_id = " + obj.getMaintenance_id());
                                                ps.setInt(1, 1);
                                                ps.setInt(2, (Integer) SPUtil.get(context, "maintainer_id", 0));
                                                ...
                                                if (exeNums == 1) {
                                                    ...
                                                    context.runOnUiThread(new Runnable() {
                                                        ...
                                                        public void run() {
                                                            ...
                                                            Toast.makeText(context, "已接取，可稍后在工作栏中查看！", Toast.LENGTH_LONG).show();
                                                        }
                                                    });
                                                } else {
                                                    context.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (conn != null) {
                        ...
                        LogUtil.logV("MaintenanceMaintainerFragment", maintenanceList.toString());
                        context.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                progressBar.setVisibility(View.GONE);
